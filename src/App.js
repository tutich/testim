...
function App() {
  return (
    <div className="App">
      <div className="dane">
        <div className="header">
          ...
          <div className="content">
            <h4 className='name'>Daniel Clifford</h4>
            <h6 className='status'>Verified Graduate</h6>
          </div>
        </div>
        <p className='intro'>I received a job offer mid-course, and the subjects I
        learned were current, if not more so, in the company I joined.I honestly feel I got every penny’s worth.</p>
        <p className='review'>
      ...
      <div className="jon">
        <div className="header">
          <div className="imgg"><img src={jona}/></div>
          <div className="content">
            <h4 className='name'>Jonathan Walters</h4>
            <h6 className='status'>Verified Graduate</h6>
          </div>
        </div>
        <p className='intro'>The team was very supportive and kept me motivated</p>
        <p className='review'> “ I started as a total newbie with virtually no coding skills. I now work as a mobile engineer for a big company.
      ...
      <div class="patii">
        ...
        <p className='review'> “ The staff seem genuinely concerned about my progress which I find really refreshing. The program gave me the confidence necessary
        to be able to go out in the world and present myself as a capable junior developer. The standard is above
      ...
      <div class="kiraa">
        ...
        I’ve often referred to it during interviews as an example of my developent experience. It certainly
        helped me land a job as a full-stack developer after receiving multiple offers. 100% recommend! ”</p>
      </div>
